...
class StatsQueries(Query):
    ...
    def get_stats_dict(self):
        stats_dict = {
            'TextToday': self.get_today_stats('handler'),
            'TextWeek': self.get_weekly_stats('handler'),
            'TextMonth': self.get_monthly_stats('handler'),
            'TextAllTime': self.get_top_ten_stats('handler')
        }
        return stats_dict
